...
s.mat.sigk = omg_cen*(delE_J/(s.SI.hbar*omg_cen))^(3/2)*(s.SI.e^2/(4*s.SI.c*s.SI.eps_0*s.SI.m_e*omg_cen^2*delE_J))^s.mat.pow; %cross section in SI (m^(2n)*s^(n-1)/J^n) where n is # of photons

...
s.f.rho_out = zeros(size(s.f.E_out));
...
last_E_field = s.f.E_out(:,:,end);
e_out_name = strcat(s.input.outpath,'end_E_field.mat');
save(e_out_name, 'last_E_field');

...
%     s.mat.NO_O2 = 5e18; %number density of O2 in the air
    ...
    s.mat.N0 = 2.504e19*1e6; %number density of air in cm^-3
    s.mat.NO_N2 = 2e19*1e6; %number density of N2 in the air
    s.mat.NO_O2 = 5e18*1e6; %number density of O2 in the air
...
%     s.mat.IT = 1e13; %Intensity factor (experimentally fitted) W/cm^2
    s.mat.IT = 1e17; %Intensity factor (experimentally fitted) W/m^2
...
%     s.mat.n2_O2 = 8.1e-20; %nonlinear index of O2 - valid at 800nm in cm^2/W
    ...
    s.mat.n2_N2 = 7.9e-20*1e-4; %nonlinear index of N2 - valid at 800nm in cm^2/W
    s.mat.n2_O2 = 8.1e-20*1e-4; %nonlinear index of O2 - valid at 800nm in cm^2/W

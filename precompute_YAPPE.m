...
s.ion.a3 = s.mat.recomb;  %I added the minus sign to account for decrease in the plasma rate because of recombination
...
s.NL.b3 = 1i*s.g.n0^2*s.NL.betak/s.g.kvac(s.g.omg_cen_loc); %not sure if the "k" in this expression should be medium or vaccuum central wavelength <- Original Nihal Comment
